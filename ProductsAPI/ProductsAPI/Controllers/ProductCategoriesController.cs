...
namespace ProductsAPI.Controllers
{
    ...
    public class ProductCategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutProductCategory(int id, ProductCategory productCategory)
        {
            ...
            var idsOfproducts = productCategory.Products.Select(x => x.ProductID).ToList();
            var productsToDelete = await _context.Product.Where(x => !idsOfproducts.Contains(x.ProductID) && x.ProductCategoryID == productCategory.ProductCategoryID).ToListAsync();
